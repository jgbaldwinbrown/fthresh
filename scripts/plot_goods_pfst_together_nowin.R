...
main <- function() {
	...
	scales_y = list (
		`black` = scale_y_continuous(limits = c(0, 30)),
		`white` = scale_y_continuous(limits = c(0, 30)),
		`runt` = scale_y_continuous(limits = c(0, 30)),
		`figurita` = scale_y_continuous(limits = c(0, 30))
	)
